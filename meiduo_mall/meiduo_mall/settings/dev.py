...
SECRET_KEY = 'zxi!0)*!^sj!5=4m3jet-kt&s@xs1llzw(=pnkjz(e#in9k=%9'
...
# Session -> 缓存, 缓存 -> Redis, Session -> Redis
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'maxBytes': 300 * 1024 * 1024,  # 大小
            'backupCount': 10,  # 个数
            'formatter': 'verbose'  # 格式
        },
    },
    'loggers': {  # 日志器
...
EMAIL_PORT = 25
#发送邮件的邮箱
EMAIL_HOST_USER = 'hoxi_0818@163.com'
#在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = '123456abc'
#收件人看到的发件人
EMAIL_FROM = '美多商城<hoxi_0818@163.com>'
...
# 支付宝配置
ALIPAY_APPID = "2016092800613949" # 开发者应用APPID
